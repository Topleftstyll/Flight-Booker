...
ActiveRecord::Schema.define(version: 2021_07_01_043751) do
  ...
  add_foreign_key "flights", "airlines", column: "from_airport_id"
  add_foreign_key "flights", "airlines", column: "to_airport_id"
end
